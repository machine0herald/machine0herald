...
\definecolor{DarkPastelRed}{HTML}{434343}
...
\begin{document}
  ...
  \begin{paracol}
    ...
    \cvevent{Colossus}{Robotics Student Association}{Mar 2025 -- Present} {}
    Colossus is a 6 degree-of-freedom Cobot (Collaborative Robot arm) that I am
    designing and building as a member of the Robotics Student Association (RSA)
    at TU Delft. In this project I have taken on the role of Mechanical,
    Electrical and Software Engineer. The arm is intended for educational and research
    purposes.

    % \vspace{0.5\baselineskip} % Adds an empty line before skills
    % Skills:
    % \begin{itemize}
    %   \item Mechanical design and CAD modeling
    %   \item C++ and Python programming
    %   \item ROS2 integration
    %   \item PCB design and fabrication
    %   \item 3D printing and prototyping
    ...
    minor I am working on a project to design and build an automated cable cleaning
    robot for Prysmian. The project is being carried out in collaboration with
    ...
    on decided to create a new arm under the name 'Colossus', keeping in mind
    the new insights i had gained.

    \divider

    \cvevent{Hexapod Robot}{Robotics Student Association}{May 2024}{} In May 2024
    ...
    % \cvachievement{\faHeartbeat}{Another achievement}{more details about it of course}
    % ////////////////////////////////////////////////////////////////////
    \cvsection{Education} \cvevent{B.Sc.\ Mechanical Engineering}{TU Delft}{Sept 2022 -- June 2026}{}
    ...
    \cvsubsection{Programming} \cvtag{C++} \cvtag{Python} \cvtag{ROS} \cvtag{Platform IO}
    \cvtag{Git}\\
    ...
    % ////////////////////////////////////////////////////////////////////
    \cvsection{Extracurricular} \cvevent{Workshop Commission}{Robotics Student Association Delft}{Sept 2025 -- Current}{}
    \cvevent{Student Mentor}{TU Delft - Faculty of Mechanical Engineering}{Sept 2024 -- Feb 2025}{}
    \cvevent{Teachers Assistant - CAD}{TU Delft - Faculty of Mechanical Engineering}{Nov 2023 -- Feb 2025}{}
    ...
    \begin{small}
      \cvsubsection{SolidWorks} \cvevent{CSWA (Associate)}{SolidWorks Corporation}{Nov 2022}{}
      % \cvevent{CSWA – Simulation}{SolidWorks Corporation}{Jun 2023}{}
      \cvevent{CSWP (Professional)}{SolidWorks Corporation}{Jun 2023}{}
      % \cvevent{CSWPA (Professional Advanced) – Drawings}{SolidWorks Corporation}{Jul 2023}{}
      % \cvevent{CSWPA – Weldments}{SolidWorks Corporation}{Jul 2023}{}
      % \cvevent{CSWPA – Sheetmetal}{SolidWorks Corporation}{Jul 2023}{}
      % \cvevent{CSWPA – Surfacing}{SolidWorks Corporation}{Aug 2023}{}
      \cvevent{CSWE (Expert)}{SolidWorks Corporation}{Nov 2023}{}
    \end{small}
  \end{paracol}
\end{document}