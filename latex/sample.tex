...
\definecolor{GitHubGreen}{HTML}{0FBF3E}
\definecolor{GitHubBlue}{HTML}{1F6FEB}

\definecolor{SlateGrey}{HTML}{2E2E2E}
\definecolor{LightGrey}{HTML}{333333}
\definecolor{DarkPastelRed}{HTML}{434343}
\definecolor{PastelRed}{HTML}{8F0D0D}
\definecolor{GoldenEarth}{HTML}{8CF2A6}
\colorlet{name}{white}
\colorlet{tagline}{GitHubBlue}
\colorlet{heading}{GitHubBlue}
\colorlet{headingrule}{GoldenEarth}
\colorlet{subheading}{GitHubBlue}
\colorlet{accent}{GitHubBlue}
\colorlet{emphasis}{white}
\colorlet{body}{white}
\pagecolor{GitHubBlack}
\color{white}
...
\begin{document}
  ...
  \begin{paracol}
    ...
    \cvevent{Cora}{Robotics Student Association}{Mar 2025 -- Present} {}
    Cora is a 6 degree-of-freedom cobot (Collaborative Robot arm) that I am
    ...
    Electrical and Software Engineer. Since march 2026, the team has expanded to five members with backgrounds in Mechanical Engineering, Electrical Engineering and computer science
